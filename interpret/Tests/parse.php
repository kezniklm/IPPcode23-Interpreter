...
/**
 * Overenie ⟨Variable⟩ podľa regulárneho výrazu
...
/** @Variable $instruction - Počet inštrukcií*/
$instruction = 1;

/** @Variable $header_flag - Značí prítomnosť hlavičky - IPPcode23 */
$header_flag = false;
...
while ($line = fgets(STDIN))
{
    ...
    /** @Variable $comment_flag - Značí prítomnosť komentára */
    $comment_flag = false;
    $clean_line = [];
    ...
    switch (strtoupper($clean_line[0]))
    {
        ...
        case "POPS":
            ...
            create_XML($clean_line, ONE_OP, $instruction++, "Variable", NULL, NULL);
            break;
        case "LABEL":
        case "CALL":
        case "JUMP":
        ...
        case "NOT":
            ...
            create_XML($clean_line, TWO_OPS, $instruction++, "Variable", "symb", NULL);
            break;
        case "READ":
            check_op_number($clean_line, TWO_OPS);
            var_check($clean_line[FIRST_OP]);
            type_check($clean_line[SECOND_OP]);
            create_XML($clean_line, TWO_OPS, $instruction++, "Variable", "type", NULL);
            break;
        case "ADD":
        case "SUB":
        case "MUL":
        ...
        case "SETCHAR":
            ...
            create_XML($clean_line, THREE_OPS, $instruction++, "Variable", "symb", "symb");
            break;
        case "JUMPIFEQ":
        case "JUMPIFNEQ":
            check_op_number($clean_line, THREE_OPS);
